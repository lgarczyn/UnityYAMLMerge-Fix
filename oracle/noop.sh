#!/bin/sh
# No-op merge sweep: base == ours == theirs over a corpus sample must be
# rc 0 and byte-identical for every file. Catches verifier false
# positives and codec churn at scale. Hightower only.
#
